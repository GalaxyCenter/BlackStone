...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		buf1 = new StringBuffer();
		buf1.append("create table if not exists ");
		buf1.append(Constants.APOLLO_DATA_TABLE_AUTOPOST_CONFIG);
		buf1.append(" (");		
		buf1.append(Config.Columns.ID);
		buf1.append(" integer primary key autoincrement,");
		buf1.append(AutoPostConfig.Columns.SECTION_ID);
		buf1.append(" varchar(8),");
		buf1.append(AutoPostConfig.Columns.THREAD_ID);
		buf1.append(" integer,");
		buf1.append(AutoPostConfig.Columns.THREAD_SUBJECT);
		buf1.append(" varchar(128),");
		buf1.append(AutoPostConfig.Columns.FLOOR_NUM);
		buf1.append(" integer,");
		buf1.append(AutoPostConfig.Columns.ACCOUNTS);
		buf1.append(" text,");
		buf1.append(AutoPostConfig.Columns.POST_BODY);
		buf1.append(" text,");
		buf1.append(AutoPostConfig.Columns.START_TIME);
		buf1.append(" varchar(20),");
		buf1.append(AutoPostConfig.Columns.END_TIME);
		buf1.append(" varchar(20))");
