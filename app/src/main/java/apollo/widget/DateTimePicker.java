...
public class DateTimePicker implements OnClickListener {
	...
	public interface OnDateTimeSetListener {
		public void onDateTimeSet(Calendar calendarSelected, Date dateSelected,
	...
	public void onClick(View v) {
		...
		case SET:
			...
			if (listener != null) {
				...
				listener.onDateTimeSet(calendar_date, calendar_date
